...
void writeCommand(unsigned char c) {
    ...
    // Set OC pin to low
    //GPIOPinWrite(GPIOA1_BASE, 0x8, 0);   /* uncomment this first */ /* After first activation of OED, comment out this back */
    MAP_SPICSEnable(GSPI_BASE);            /* comment this first */   /* After first activation of OED, uncomment this back */
    //MAP_SPIDataPut
    //printf("Got stuck here?\n");
    MAP_SPIDataPut(GSPI_BASE, c);
    //MAP_SPIDataGet to Dummy
    //printf("Here?\n");
    MAP_SPIDataGet(GSPI_BASE, &ulDummy);
    //printf("Or here?\n");
    // Set OC pin to high
    MAP_SPICSDisable(GSPI_BASE);           /* comment this first */   /* After first activation of OED, uncomment this back */
    //GPIOPinWrite(GPIOA1_BASE, 0x8, 0x8); /* uncomment this first */ /* After first activation of OED, comment out this back */
